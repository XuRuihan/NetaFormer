...
OPS = {
    "Conv": {
        "code": 1,
        "attrs": ["kernel_shape", "strides", "pads", "dilations", "group", "bias",],
    },
    "Relu": {"code": 2, "attrs": [],},
    "Add": {"code": 3, "attrs": [],},
    "Sigmoid": {"code": 4, "attrs": [],},
    "Reshape": {"code": 5, "attrs": [],},
    "MaxPool": {
        "code": 6,
        "attrs": [
            "kernel_shape",
    ...
    "Split": {"code": 7, "attrs": [],},
    "GlobalAveragePool": {"code": 8, "attrs": [],},
    "Gemm": {"code": 9, "attrs": ["bias",],},
    "Transpose": {"code": 10, "attrs": ["perm",]},
    "Upsample": {"code": 11, "attrs": [],},
    "BatchNormalization": {"code": 12, "attrs": [],},
    "Mul": {"code": 13, "attrs": [],},
    "Concat": {"code": 14, "attrs": [],},
    "Flatten": {"code": 15, "attrs": [],},
    "AveragePool": {"code": 16, "attrs": ["kernel_shape", "strides", "pads",],},
    "Cast": {"code": 17, "attrs": [],},
    "Matmul": {"code": 18, "attrs": [],},
    "ReduceMean": {"code": 19, "attrs": [],},
    "Pow": {"code": 20, "attrs": [],},
    "Slice": {"code": 21, "attrs": [],},
    "Div": {"code": 22, "attrs": [],},
    "Sub": {"code": 23, "attrs": [],},
